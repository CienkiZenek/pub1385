...
<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
    ...
    <div class="row">
        ...
        <div class="fs-3 mb-3">{{ $haslo -> haslo}}</div>

        {{-- Twitowanie tylko zaznaczonego fragmentu - button twittera wszystko przebija,
         a display:none uniemożliwia załodwanie widgetu...  --}}
        {{--<div id="tw_zazn" class="fs-5 mb-2 align-text-top" style="opacity:0; ">Opublikuj zazanczony fragment:
        ...
        <div class="d-flex mt-4 mb-4">
            ...
            <a class="twitter-share-button"
               ...
               data-size="large"
               data-lang="pl"
               data-text="{{Str::limit(strip_tags($haslo->tresc), 2500)}}"
               data-url="{{Request::url()}}"
            >
                Tweet
            </a>
...
@endif
        @if(Auth::user()->mozeKomentowac())
            <div class=" fs-5 mt-5">Moja nowa uwaga do tego hasła:</div>
